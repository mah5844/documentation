...
Under this, in the :guilabel:`Quotation Templates` section, you can restrict this PDF to some
quotation templates only.
...
.. note::
   ...
   button, and proceed to upload the custom document(s) to the specific product variant.
...
The smart button navigates to a :guilabel:`Documents` page for that product, wherein files related
to that product can be uploaded. From this page, either click :guilabel:`New` or :guilabel:`Upload`.

Clicking :guilabel:`Upload` opens the computer's local file directory, where a document can be
selected to upload. The document can be further configured on the document card, or by clicking the
three dots icon in the top-right corner of the document card, and then clicking :guilabel:`Edit`.
...
On a sales order, in the :guilabel:`Quote Builder` tab, select additional documents to
be merged into the final PDF. If a selected document has custom fields, they appear as editable
